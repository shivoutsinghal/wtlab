...
<?php
  if(isset($_POST['body'],$_POST['subject'],$_POST['editIdNL'],$_POST['typeOfNL']))
  {
      $NewsletterID = $mysqli->real_escape_string($_POST['editIdNL']);
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title><?php echo $Heading;?> Newsletter| WhiteLeaf Trek & Tour </title>
        ...
        <div id="content">
            ...
            <div class="content-wrapper">
                <div id="page-heading" class="page-header">
                    <h2><i class="icon im-pencil4"></i> <?php echo $Heading;?> Newsletter </h2>
                    <!-- Start .bredcrumb -->
                ...
                <div class="content-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal mb25" role="form" id="validate" method="post" action="nl_edit_db.php">
                            	<div class="form-group">
                                      <label for="subject" class="col-lg-2 col-md-3 control-label">Subject <span class="text-danger"> * </span> </label>
                                            <div class="col-lg-10 col-md-9">
                                                <input id="subject" type="text" value="<?php echo $subject ; ?>" name="subjectNewsletter" class="form-control required">
                                            </div>
                                    </div>
                                ...
                                <div class="form-group">
                                	<label for="texteditor" class="col-lg-2 col-md-3 control-label">Body <span class="text-danger"> * </span> </label>
                                	 <div class"col-lg-10 col-md-9">
                                       <textarea name="bodyNewsletter" id="texteditor" class="form-control required tinymce"><?php echo $body; ?> </textarea>
                                   </div>
                                </div>
                                <!-- End .form-group  -->
                                 ...
                                 <div class="form-group">
                                         <div class="col-xs-offset-2">
                                                  ...
                                                  <button class="btn btn-lg btn-primary mr5 mb10" type="submit" name="editNewsletter">Save Changes</button>
