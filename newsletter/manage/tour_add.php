...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Add Tour | WhiteLeaf Trek & Tour </title>
        ...
        <div id="content">
            ...
            <div class="content-wrapper">
                <div id="page-heading" class="page-header">
                    <h2><i class="icon im-plus"></i> Add Tour </h2>
                    <!-- Start .bredcrumb -->
                ...
                <div class="content-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal group-border stripped" role="form" id="validate" method="post" action="tour_add_db.php">
                            	<div class="form-group">
                                      <label for="tourName" class="col-lg-2 col-md-3 control-label">Tour Name <span class="text-danger"> * </span> </label>
                                            <div class="col-lg-10 col-md-9">
                                                <input id="tourName" type="text" name="tourName" class="form-control required">
                                            </div>
                                </div>
                                <!-- End .form-group -->
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 col-md-3 control-label">Duration <span class="text-danger"> * </span> </label>
                                        <div class="col-lg-10 col-md-8">
                                                <div class="col-lg-5 col-md-4">
                                                    <input class="form-control required " type="number" id="dayDuration" value="1" min="1" step="1" name="dayDuration" >
                                                    <span class="text-danger">Days </span> 
                                                </div>
                                                <div class="col-lg-5 col-md-4">
                                                    <input class="form-control required " type="number" id="nightDuration" value="1" min="1" step="1" name="nightDuration">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-10 col-md-9">
                                        <input class="form-control required datepicker" type="text" value="" id="startDate" name="startDate">
                                    </div>
                                 </div>
                                 <!-- End .form-group -->
                                 ...
                                 <div class="form-group">
                                      <label for="tourPackage" class="col-lg-2 col-md-3 control-label">Package <span class="text-danger"> * </span> </label>
                                            <div class="col-lg-6 col-md-6">
                                                <input id="tourPackage" type="number" min="1" step="any" value="0" name="tourPackage" class="form-control required">
                                            </div>
                                </div>
                                 <!-- End .form-group -->
                                ...
                                <!-- End .form-group  -->
                                 ...
                                 <div class="form-group">
                                    <div class="col-xs-offset-2">
                                         <button class="btn btn-lg btn-primary mr5 mb10" type="submit" name="addTour">Add</button>
